...
description: Draft bet-level technical strategy. Architect leads, Enterprise/Solution Architect joins.
---

Execute the workflow at `compass/workflows/create-epic-architecture.md`.
