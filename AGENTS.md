...
**Scope-discipline patterns govern Compass's own scope at framework design time** (release planning, codification decisions, roadmap deferrals), distinct from the workflow-execution shapes. **Architecture-discipline patterns govern the structural composition of agents / workflows / hosts**, introduced in v0.3.14. **Catalog now spans 7 shapes / 13 patterns** (post-v0.3.17): enforcement (4) · interaction (1) · freshness (1) · observability (1) · handoff (2) · scope-discipline (2) · **architecture-discipline (2)**. Workflow-execution patterns total 9; scope-discipline patterns total 2; architecture-discipline patterns total 2. **The scope-discipline shape is structurally validated** — v0.3.9 introduced with `[declare-not-implement]`; v0.3.10 grew to 2 members with `[hard-line-declaration]`. **The architecture-discipline shape is now also structurally validated** — v0.3.14 introduced with `[agent-as-surface-independent-unit]`; v0.3.17 grew to 2 members with `[fractal-retro]`.
