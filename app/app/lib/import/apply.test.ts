...
describe("re-running", () => {
  const already: Existing = {
    ...
    workflows: [{
      code: "build",
      steps: [
        { workflow: "build", ord: 1, kind: "agent", role: "engineer", task: "implement", produces: "", reads: [], conditional: "", nests: "" },
        { workflow: "build", ord: 2, kind: "agent", role: "engineer", task: "test", produces: "", reads: [], conditional: "", nests: "" },
      ],
