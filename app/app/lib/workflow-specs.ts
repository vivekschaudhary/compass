...
export const WORKFLOW_SPECS: Record<string, WorkflowSpec> = {
  ...
  "tech-design":    { role: "staff-engineer",    verb: "Tech design",      artifact: "confluence", gate: true,  gateRole: "engineer", focus: "Produce a technical design: approach, key components/interfaces, data shape, risks, and a build sequence. No code." },
  "bet-architecture":{ role: "staff-engineer",   verb: "Epic architecture",artifact: "confluence", gate: true,  gateRole: "engineer", focus: "Produce the epic-level architecture: boundaries, sequencing of the stories, and cross-cutting concerns." },
