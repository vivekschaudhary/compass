...
**Postcondition:** incident artifact exists at `docs/incidents/<incident-id>/triage.md` or `docs/epics/<epic-id>/incidents/<incident-id>/triage.md` · stop-the-bleed decision made by human (not auto-acted) · comms drafted AND HITL-approved before publishing · postmortem scheduled · ≥1 DRI Decision + ≥1 Risk logged.
