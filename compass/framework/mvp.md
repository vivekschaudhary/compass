...
Reviewer + security-reviewer declare `preferred_hosts: [claude, codex, gemini]` — any host (#155); review independence is maker ≠ checker on a fresh context, enforced at the file level.
