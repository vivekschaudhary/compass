...
**Next retro fires after improvement #40.** (Retro #007 fired at #35 ON TIME 2026-06-07. **v0.3.21 = #38 (2 of 5 needed before Retro #008).** Hard line still in effect — if Retro #008 slips, it's a 2nd retro-cadence regression since `[hard-line-declaration]` codification; treat as recurring soft-spec failure and deepen mechanism per Retro #006 + #007 recommendations (e.g., make counter + retro-due flag visible in dashboard Actions tab).)
