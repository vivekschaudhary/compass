...
3. **Load Delivery Manager agent** (`compass/agents/delivery-manager.md`) — Delivery Manager owns rolling project scheduling. (Migrated + renamed v0.3.15; legacy role file at `compass/roles/project-manager.md` removed in v1.0 (#38).)
